...
<body>
    <div class="header">
        <div class="text">
            <h1 class="fadeIn">Question 1</h1>
            <h2 class="fadeIn">Upcoming Valentine's Day is our ___________ valentine.</h2>
        </div>
        <img class="fadeIn" style ="height: auto; width: 15%;"src="./pics/twerk.gif" />
            <div class="btn-group fadeIn ">
                <button class = "btn"  onclick="showPopup('wrong')"
                style = "color: white; background-color: #2076D1;">1st</button>
                <button  class = "btn " onclick="showPopup('wrong')"
                style = "color: white; background-color: #2076D1;">2nd</button>
                <button name = "not" class = "btn " onclick="showPopup('correct')"
                style = "color: white; background-color: #2076D1;">3rd</button>
                <button name = "not" class = "btn " onclick="showPopup('wrong')"
                style = "color: white; background-color: #2076D1;">4th</button>
            </div>
    </div>
    ...
    <div id="correctPopup" class="popup">
        <div class="popup-content">
            ...
            <h4>the next one will be harder but i know u can do it</h4>
            <img class="fadeIn" style ="height: auto; width: 50%;"src="./pics/wow.gif" />
            <form action="functions.php" method = "post">
                <button class = "next-btn"  onclick="showPopup('correct')" name="next1"
